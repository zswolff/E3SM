        ...
        if (c == 0):
            if (v == 0):
                ...
                for ftype in range(0,2):
                    outdata = netcdf.netcdf_file(mycases[0]+"_"+mysites[0]+"_"+analysis_type+'_'+ftype_suffix[ftype]+".nc","w",mmap=False)
                    ...
                    outdata.close()
        for ftype in range(0,2):
            outdata = netcdf.netcdf_file(mycases[0]+"_"+mysites[0]+"_"+analysis_type+'_'+ftype_suffix[ftype]+".nc","a",mmap=False)
            if (c == 0):
