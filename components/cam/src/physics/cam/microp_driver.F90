...
!-zhx subroutine microp_driver_tend(state, ptend, dtime, pbuf)
subroutine microp_driver_tend(state, ptend, dtime, pbuf, macmic_it) !+zhx
   ...
   integer, intent(in)  :: macmic_it                    ! substep  !+zhx
   ...
   case ('MG')
      ...
      !-zhx call micro_mg_cam_tend(state, ptend, dtime, pbuf)
      call micro_mg_cam_tend(state, ptend, dtime, pbuf, macmic_it) !+zhx
